...
import {SqlString} from 'react-awesome-query-builder/lib/utils/sql';
...
//   renderConjs: (props) => <MaterialConjs {...props} />,
  // renderButton: (props) => <button {...props} style={{...props.style}}>{(console.log(props), true) && props.label}</button>,
